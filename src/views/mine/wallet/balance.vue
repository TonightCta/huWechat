        ...
        <div class="wrapper" @click.stop>
          <div class="turnPay">
            ...
            <p v-else class="addPayInp">
              <van-icon name="alipay" color="rgb(17,157,238)"/>
              <input type="text" name="" placeholder="支付宝" value="" style="fontSize:1.4rem;">
      ...
      <van-overlay :show="tiXiaSucc" @click="tiXiaSucc = false">
        <div class="wrapper" @click.stop>
          <div class="turnPay">
            ...
            <p style="paddingBottom:1rem;">提现成功</p>
          </div>
        </div>
      </van-overlay>
    </div>
      ...
      <van-overlay :show="tiXiaErr" @click="tiXiaErr = false">
        <div class="wrapper" @click.stop>
          <div class="turnPay">
            ...
            <p style="paddingBottom:1rem;">提现失败</p>
          </div>
        </div>
      </van-overlay>
    </div>
