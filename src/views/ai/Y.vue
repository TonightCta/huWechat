...
<template lang="html">
  <div class="w">
    <div class="w_title">
      ...
      <img src="../../assets/images/yIcon.png" alt="">
    </div>
    <div class="w_con">
      <p class="w_title1">
        <span></span>
  ...
  methods:{
    getYDe(){//获取选股详情
      ...
      this.$axios.get(this.Uapi+'/user/index/aiyxinfo?id='+Aid,{
        ...
        if(res.data.state==1){
          this.yMes=res.data.data;
          let date=new Date(this.yMes.createtime*1000);
    ...
    getYEc(){//获取选股Echarts数据
      ...
      this.$axios.get(this.Uapi+'/user/index/dailyhq?symbol='+this.yMes.jinri[0][0]+'&start_date=20200101&end_date='+this.startTime,{
        headers:{
          'Authorization':this.baseToken,
          'SessionId':this.baseID,
          'v':'v2'
